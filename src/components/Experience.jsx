...
const Experience = () => (
  <section id="experience" className="relative z-0 py-16 px-0 w-full bg-[color:var(--bg)] border-t-2" style={{ borderTopColor: 'var(--text)' }}>
        ...
        <VerticalTimeline lineColor="var(--violet)">
          {experiences.map((work, i) => (
            ...
            >
              ...
              <p className="text-[color:var(--violet)] text-base mt-2" style={{ textAlign: "left" }}>{work.description}</p>
            </VerticalTimelineElement>
          ))}
        </VerticalTimeline>
      </div>
