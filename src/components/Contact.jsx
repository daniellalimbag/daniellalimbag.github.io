  ...
  return (
    ...
    >
      ...
      <div className="w-auto flex flex-col justify-center items-center relative z-10 px-0">
        <form onSubmit={handleSubmit} className="w-[600px] bg-gradient-to-br from-[color:var(--violet)]/90 via-[color:var(--blue)]/80 to-[color:var(--green)]/70 dark:from-[color:var(--green)]/90 dark:via-[color:var(--blue)]/80 dark:to-[color:var(--green)]/70 border-2 border-[color:var(--violet)] dark:border-[color:var(--green)] shadow-2xl rounded-2xl px-8 py-12 flex flex-col gap-6 backdrop-blur-md">
          <input
            type="text"
            name="name"
            value={form.name}
            ...
            className="w-full px-4 py-3 rounded-md bg-[color:var(--bg)] border border-[color:var(--violet)] dark:border-[color:var(--green)] text-sm text-[color:var(--text)] placeholder-[color:var(--violet)] dark:placeholder-[color:var(--green)] focus:outline-none focus:ring-2 focus:ring-[color:var(--violet)] dark:focus:ring-[color:var(--green)] transition"
            disabled={loading}
          />
          <input
            type="email"
          ...
          <textarea
            ...
            rows={5}
            className="w-full px-4 py-3 rounded-md bg-[color:var(--bg)] border border-[color:var(--violet)] dark:border-[color:var(--green)] text-sm text-[color:var(--text)] placeholder-[color:var(--violet)] dark:placeholder-[color:var(--green)] focus:outline-none focus:ring-2 focus:ring-[color:var(--violet)] dark:focus:ring-[color:var(--green)] resize-none transition"
            disabled={loading}
          />
          <button
            type="submit"
            className="w-full py-3 rounded-md bg-gradient-to-r from-[color:var(--violet)] dark:from-[color:var(--green)] to-[color:var(--blue)] dark:to-[color:var(--green)] text-white font-semibold text-sm shadow-lg transition
          ...
          {status && (
            <div className={`text-center text-sm mt-2 ${status.startsWith('Thank') ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
              {status}
            </div>
          )}
        </form>
